...
What is an atmospheric river? Read our [Quick Study: Rivers in the sky](https://doi.org/10.1063/pt.171e3ee933) in Physics Today for an overview!
...
<img src="/assets/trendfig_forwebsite.png" 
     ...
     style="float: left; width: 35%; margin: 1em 1.5em 1em 0;">
ARs have a major influence on water resources and rainfall in many regions, but there is still  uncertainty about how these storms may have changed over time. When we extend the global record of AR activity back to 1940, we find that the frequency of ARs has increased broadly across the midlatitude regions, rather than shifting polewards as observed in recent decades. This leads to more rain, snow, and humid heatwaves in the mid- and high-latitudes. 
<div style="clear: both;"></div>

Scholz, S. R. & J.M. Lora (2025). [Widespread increase in atmospheric river frequency and impacts over the 20th century](https://doi.org/10.1029/2025AV001888). AGU Advances, 6, e2025AV001888.\
...
<img src="/assets/ECMode_pic_website.png" 
     alt="English Channel mode"
     style="float: right; width: 33%; margin: 1em 0 1em 1.5em;">

As an undergrad, I worked with [Dr. Richard Seager](https://ocp.ldeo.columbia.edu/res/div/ocp/people/seager/) at Lamont. We analyzed long term modes of variability in European hydroclimate, using a tree-ring based reconstruction of scPDSI. Although a pattern similar to the expression of the winter NAO dominates variability over the last century, we found that previous centuries were dominated by the "English Channel" mode, which exhibits pronounced centennial scale variability. Research led by [S. Hun Baek](https://seunghbaek.github.io/) linked this mode to the Great Famine of 1315-1317, when massive deluges lead to widespread crop failures across Europe.
