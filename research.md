...
As an undergrad, I worked with [Dr. Richard Seager](https://ocp.ldeo.columbia.edu/res/div/ocp/people/seager/) during a summer internship at Lamont. We analyzed long term modes of variability in European hydroclimate, using a tree-ring based reconstruction of scPDSI called the Old World Drought Atlas. Although a pattern similar to the expression of the winter North Atlantic Oscillation (NAO) dominates hydroclimate variability in the last century, we found that previous centuries were dominated by a different mode that we named the "English Channel" mode, which exhibits pronounced centennial scale variability. This mode of variability was also linked to the Great Famine of 1315-1317, during which time massive deluges lead to widespread crop failures and famines across Europe.
