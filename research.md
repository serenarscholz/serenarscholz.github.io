...
As an undergrad, I worked with [Dr. Richard Seager](https://ocp.ldeo.columbia.edu/res/div/ocp/people/seager/) during a summer internship at Lamont. We analyzed long term modes of variability in European hydroclimate, using a tree-ring based reconstruction of scPDSI. Although a pattern similar to the expression of the winter NAO dominates hydroclimate variability in the last century, we found that previous centuries were dominated by a different mode that we named the "English Channel" mode, which exhibits pronounced centennial scale variability. Research led by [S. Hun Baek](https://seunghbaek.github.io/) also linked this mode the Great Famine of 1315-1317, during which time massive deluges lead to widespread crop failures and famines across Europe.
