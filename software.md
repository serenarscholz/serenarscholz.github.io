...
Island is a modification to the hierarchical modeling framework [Isca](https://execlim.github.io/IscaWebsite/) that allows customizable land surfaces, including a simple representation of the effect of plants on evaporation. Users can create and input custom maps of albedo, surface roughness, and stomatal conductance. Once the modifications are integrated into the Isca codebase, code and documentation will be made available on GitHub.

<div style="text-align: center; margin: 1em 0;">
  <img src="/assets/island_demo.png" alt="AR identification" style="width: 90%; display: inline-block;">
</div>
